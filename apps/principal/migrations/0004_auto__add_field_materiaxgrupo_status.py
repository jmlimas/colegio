...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MateriaxGrupo.status'
        db.add_column(u'principal_materiaxgrupo', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MateriaxGrupo.status'
        db.delete_column(u'principal_materiaxgrupo', 'status')
