...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'principal_empresa', (
            ...
            ('rfc', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'principal', ['Empresa'])
        ...
        db.create_table(u'principal_alumno', (
            ...
            ('apellidos', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ...
            ('sexo', self.gf('django.db.models.fields.CharField')(max_length=1, null=True)),
            ('hermanos', self.gf('django.db.models.fields.CharField')(default='No', max_length=2)),
            ('direccion', self.gf('django.db.models.fields.CharField')(max_length=140, null=True)),
            ('colonia', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('telefono', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('celualr', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('cp', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('ciudad', self.gf('django.db.models.fields.CharField')(max_length=60, null=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=60, null=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=50, unique=True, null=True)),
            ('nivel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Nivel'], null=True, blank=True)),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Grupo'], null=True, blank=True)),
            ('padre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Padre'], null=True, blank=True)),
            ('contacto', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        ...
        db.create_table(u'principal_materia', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('materia', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('nivel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Nivel'], null=True, blank=True)),
        ))
        ...
        # Adding model 'Mes'
        db.create_table(u'principal_mes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal(u'principal', ['Mes'])
        ...
        # Adding model 'MateriaxGrupo'
        db.create_table(u'principal_materiaxgrupo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'principal', ['MateriaxGrupo'])

        # Adding model 'Cicloescolar'
        db.create_table(u'principal_cicloescolar', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('descripcion', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('fechaini', self.gf('django.db.models.fields.DateField')()),
            ('fechafin', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'principal', ['Cicloescolar'])


    def backwards(self, orm):
        # Deleting model 'Empresa'
        db.delete_table(u'principal_empresa')
        ...
        # Deleting model 'Mes'
        db.delete_table(u'principal_mes')

        # Deleting model 'Calificacion'
        db.delete_table(u'principal_calificacion')

        # Deleting model 'MateriaxGrupo'
        db.delete_table(u'principal_materiaxgrupo')

        # Deleting model 'Cicloescolar'
        db.delete_table(u'principal_cicloescolar')
