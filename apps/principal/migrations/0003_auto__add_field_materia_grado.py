...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Materia.grado'
        db.add_column(u'principal_materia', 'grado',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Grado'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Materia.grado'
        db.delete_column(u'principal_materia', 'grado_id')
