...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MateriaxGrupo', fields ['materia']
        db.delete_unique(u'principal_materiaxgrupo', ['materia_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'MateriaxGrupo', fields ['materia']
        db.create_unique(u'principal_materiaxgrupo', ['materia_id'])
