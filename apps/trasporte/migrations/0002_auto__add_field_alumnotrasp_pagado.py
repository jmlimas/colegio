...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumnoTrasp.pagado'
        db.add_column(u'trasporte_alumnotrasp', 'pagado',
                      self.gf('django.db.models.fields.CharField')(default='NO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumnoTrasp.pagado'
        db.delete_column(u'trasporte_alumnotrasp', 'pagado')
    ...
    models = {
        ...
        u'trasporte.alumnotrasp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'pagado': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
