...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cobranza.fechapago'
        db.alter_column(u'finanzas_cobranza', 'fechapago', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cobranza.fechapago'
        db.alter_column(u'finanzas_cobranza', 'fechapago', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'finanzas.cobranza': {
            'Meta': {'ordering': "['totalapagar']", 'object_name': 'Cobranza'},
