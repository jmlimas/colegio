...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConceptoCobro'
        db.create_table(u'finanzas_conceptocobro', (
            ...
            ('nivel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuracion.Nivel'], null=True, blank=True)),
            ('importe', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('fechaLimitePago', self.gf('django.db.models.fields.DateField')(null=True)),
            ('penaliza', self.gf('django.db.models.fields.CharField')(default='No', max_length=2, null=True)),
            ('importeMulta', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal(u'finanzas', ['ConceptoCobro'])

        # Adding model 'Banco'
        db.create_table(u'finanzas_banco', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('convenio', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'finanzas', ['Banco'])

        # Adding model 'BecaAlumno'
        db.create_table(u'finanzas_becaalumno', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('alumno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Alumno'], unique=True)),
            ('porcentaje', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'finanzas', ['BecaAlumno'])

        # Adding model 'Cobranza'
        db.create_table(u'finanzas_cobranza', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('alumno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Alumno'])),
            ('concepto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finanzas.ConceptoCobro'])),
            ('beca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finanzas.BecaAlumno'], null=True, blank=True)),
            ('recargo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('tipopago', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('referencia', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('banco', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finanzas.Banco'], null=True, blank=True)),
            ('numCorte', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('totalapagar', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('fechaCorte', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('fechapago', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('pagado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'finanzas', ['Cobranza'])


    def backwards(self, orm):
        # Deleting model 'ConceptoCobro'
        db.delete_table(u'finanzas_conceptocobro')

        # Deleting model 'Banco'
        db.delete_table(u'finanzas_banco')

        # Deleting model 'BecaAlumno'
        db.delete_table(u'finanzas_becaalumno')

        # Deleting model 'Cobranza'
        db.delete_table(u'finanzas_cobranza')
    ...
    models = {
        ...
        u'finanzas.conceptocobro': {
            ...
            'importeMulta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
